...
import { ConsultantRoute } from './pages/consultant/ConsultantRoute';
      ...
      <CompareProvider>
        <ConsultantLinkProvider>
          <Routes>
            ...
            <Route
              path="/sales-manager"
              element={<ConsultantRoute role="Sales Manager" basePath="/sales-manager" navItems={SALES_MANAGER_NAV} />}
            >
              <Route index element={<Navigate to="dashboard" replace />} />
            ...
            <Route
              path="/sales-person"
              element={<ConsultantRoute role="Sales Person" basePath="/sales-person" navItems={SALES_PERSON_NAV} />}
            >
              <Route index element={<Navigate to="dashboard" replace />} />
              <Route path="dashboard" element={<ConsultantDashboardPage />} />
              <Route path="performance" element={<PerformancePage />} />
            ...
            <Route path="/broker" element={<ConsultantRoute role="Broker" basePath="/broker" navItems={BROKER_NAV} />}>
              <Route index element={<Navigate to="dashboard" replace />} />
